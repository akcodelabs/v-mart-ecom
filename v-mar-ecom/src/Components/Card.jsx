...
const ProductCard = ({ name,description, image, price, rating,actualPrice=null,review=0,label }) => {
    ...
    >
      ...
      <div style={cardStyles.info}>
        ...
        <div style={cardStyles.priceContainer}>
          <div style={cardStyles.price}><span style={{marginRight:"4px"}}>${price}</span></div>
          {actualPrice && (<span style={cardStyles.strikePrice}>${actualPrice}</span>)}
          </div>
        ...
        >
          <LuShoppingCart style={{textAlign:"center",marginRight: "1rem" }} />
        Add
        </button>
      </div>
    </div>
